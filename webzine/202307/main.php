<ul class="row main-thumbnail-wrap">
    <li class="col-12 col-sm-6"><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=c_1&wr_id=36&pu_id=202307" class="main-thumbnail thumbnail-1"><img src="/webzine/202307/images/main-thumbnail_01.jpg" alt="이달의 보건관리자" class="img-fluid"></a></li>
    <li class="col-12 col-sm-6"><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=a_1&wr_id=45&pu_id=202307" class="main-thumbnail thumbnail-2"><img src="/webzine/202307/images/main-thumbnail_02.jpg" alt="제언-사업장 위험성평가에 있어서 보건관리자의 역할" class="img-fluid"></a></li>
...
<ul class="main-btn">
    <li>
        <a href="http://www.kaohn.or.kr/sub02/sub03_2.php" target="_blank">
            <img src="/webzine/202205/images/main-btn1.png" alt="img_thumb" class="img-fluid">
            <span>건강안전연구소 소개</span>
        </a>
    </li>
    <li>
        <a href="http://www.kaohn.or.kr/sub02/sub04.php" target="_blank">
            <img src="/webzine/202205/images/main-btn2.png" alt="img_thumb" class="img-fluid">
            <span>마음건강힐링센터 소개</span>
        </a>
    </li>
    <li>
        <a href="http://www.kaohn.or.kr/bbs/board.php?tbl=bbs81_1" target="_blank">
            <img src="/webzine/202205/images/main-btn3.png" alt="img_thumb" class="img-fluid">
            <span>구인구직</span>
        </a>
    </li>
    <li>
        <a href="<?php echo G5_BBS_URL;?>/content.php?co_id=h_6" target="_blank">
            <img src="/webzine/202205/images/main-btn4.png" alt="img_thumb" class="img-fluid">
            <span>퀴즈?퀴즈!</span>
        </a>
    </li>
</ul>
<!-- <div class="popup-wrap inner">
    <div id="pop_1" class="popup">
        <img src="/webzine/202205/images/popup_01.jpg" alt="" class="img-fluid">
        <div class="p-footer d-flex justify-content-between">
            <div class="d-flex align-items-center"><input type="checkbox" name="" id="pop_none_1" class="mr-2"> <label for="pop_none_1">다시 보지 않기</label></div>
            <button class="pop-close">닫기</button>
        </div>
    </div>
    <div id="pop_2" class="popup">
        <img src="/webzine/202205/images/popup_02.jpg" alt="" class="img-fluid">
        <div class="p-footer d-flex justify-content-between">
            <div class="d-flex align-items-center"><input type="checkbox" name="" id="pop_none_2" class="mr-2"> <label for="pop_none_2">다시 보지 않기</label></div>
            <button class="pop-close">닫기</button>
        </div>
    </div>
</div>
